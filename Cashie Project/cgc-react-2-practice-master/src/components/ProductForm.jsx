...
export default function ProductForm(props) {
	...
	useEffect(() => {
		props.match.params.id &&
			axios
				.get(
					`https://cashie-backend.herokuapp.com/api/${props.match.params.id}`,
				)
				.then((result) => {
	...
	useEffect(() => {
		axios(`https://cashie-backend.herokuapp.com/api/category`).then((result) =>
	...
	const handleSubmit = (e) => {
		...
		axios({
			method,
			url: `https://cashie-backend.herokuapp.com/api/${
